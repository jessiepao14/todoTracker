...
import type { Identifier, ObjectExpression, MemberExpression, CallExpression, OptionalMemberExpression } from '@babel/types';
...
export declare function buildLiterals(value: unknown | undefined, babelContext: BabelContext): Identifier | ObjectExpression;
